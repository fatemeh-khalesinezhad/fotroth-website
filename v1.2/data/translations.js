/**
 * FOTROTH V1.1 — Comprehensive Bilingual Localization
 * EN / FA with complete coverage of Information Architecture
 */
window.FotrothData = window.FotrothData || {};

window.FotrothData.translations = {
  en: {
    // Navigation
    nav_works: "01. Works",
    nav_collective: "02. Collective",
    nav_about: "03. About & Philosophy",
    nav_academy: "04. Academy",
    nav_journal: "05. Journal",
    nav_contact: "06. Inquiry",

    // Hero
    hero_eyebrow: "OFFICIAL VISUAL HOUSE",
    hero_subtitle: "VISUAL ARTIST • INTERNATIONAL PHOTOGRAPHER • MASTER EDUCATOR • CREATIVE DIRECTOR",
    hero_status: "PARIS / DUBAI / TEHRAN",
    hero_explore_btn: "EXPLORE EXHIBITIONS",
    hero_book_btn: "INITIATE INQUIRY",
    hero_roles: "VISUAL ARTIST • INTERNATIONAL PHOTOGRAPHER • MASTER EDUCATOR • CREATIVE DIRECTOR",

    stat_years: "Years Craftsmanship",
    stat_awards: "International Honors",
    stat_campaigns: "Commercial Campaigns",

    // Works Section
    works_tag: "EXHIBITION ARCHIVE // 7 WINGS",
    works_title: "Works & Exhibitions",
    works_lead: "Curated fine-art series, high-fashion campaigns, and commercial masterworks cataloged across seven aesthetic disciplines.",
    halls_overview_tag: "MUSEUM EXHIBITION HALLS // 7 DISCIPLINES",
    halls_overview_title: "Grand Exhibition Wings",
    halls_overview_lead: "Select an exhibition wing to explore a dedicated hall of curated projects, medium-format captures, and lighting engineering.",
    enter_wing: "ENTER EXHIBITION WING",
    return_to_wings: "← RETURN TO ALL WINGS",
    curated_works_count: "CURATED EXHIBITIONS",
    optics_specs: "OPTICS & HARDWARE",
    lighting_setup: "LIGHTING ARCHITECTURE",
    curatorial_statement: "CURATORIAL STATEMENT",
    lightbox_close: "CLOSE EXHIBITION",
    ...
    filter_modeling: "MODELING",
    filter_sport: "SPORT & AUTO",
    filter_portrait: "PORTRAIT",
    view_exhibition: "ENTER EXHIBITION",

    // Collective Section
    collective_tag: "THE CREATIVE MASTERS // ARTISTS",
    collective_title: "The Fotroth Collective",
    collective_lead: "A unified house of visionaries, master lighting engineers, and advertising craftsmen collaborating to produce world-class visual culture.",
    collective_founder_badge: "FOUNDER & CREATIVE DIRECTOR",
    collective_specialist_badge: "LIGHTING & RETOUCHING SPECIALIST",
    view_dossier: "VIEW ARTIST DOSSIER",
    born_lbl: "ORIGIN",
    education_lbl: "EDUCATION",
    expertise_lbl: "CORE EXPERTISE",
    clients_lbl: "SELECT COLLABORATORS",
    exhibitions_lbl: "SELECTED EXHIBITIONS",
    ...
    about_tag: "MANIFESTO & HERITAGE",
    about_title: "The Geometry of Silence",
    about_lead: "FOTROTH operates as a premier visual arts house: 60% Luxury Commercial Direction, 25% Museum & Fine Art Exhibitions, and 15% Master Education.",
  ...
  fa: {
    // Navigation
    nav_works: "۰۱. آثار و نمایشگاه‌ها",
    nav_collective: "۰۲. اعضای گروه",
    nav_about: "۰۳. درباره و فلسفه",
    nav_academy: "۰۴. آکادمی فتروث",
    nav_journal: "۰۵. ژورنال",
    nav_contact: "۰۶. درخواست همکاری",

    // Hero
    hero_eyebrow: "مقر رسمی خانه هنری فتروث",
    ...
    // Works Section
    works_tag: "آرشیو نمایشگاهی // ۷ بال تخصصی",
    works_title: "آثار و پروژه‌های شاخص",
    works_lead: "کمپین‌های ادیتوریال، مجموعه‌های هنر والا و پروژه‌های تجاری لوکس دسته‌بندی‌شده در هفت قلمرو زیباشناختی.",
    halls_overview_tag: "تالارهای هفت‌گانه نمایشگاهی // موزه فتروث",
    halls_overview_title: "تالارهای اصلی نمایشگاه",
    halls_overview_lead: "برای ورود به تالار اختصاصی هر حوزه و کاوش در گالری پروژه‌ها، بال مورد نظر را انتخاب فرمایید.",
    enter_wing: "ورود به تالار نمایشگاه",
    return_to_wings: "← بازگشت به تمام تالارها",
    curated_works_count: "اثر نمایشگاهی",
    optics_specs: "اپتیک و دوربین",
    lighting_setup: "معماری نورپردازی",
    curatorial_statement: "بیانیه نمایشگاهی",
    lightbox_close: "بستن نمایشگاه",
    
    // Filters
    filter_all: "همه حوزه‌ها",
    filter_fashion: "مد و فشن",
    filter_food: "غذا و آشپزی",
    filter_architecture: "معماری مینی‌مال",
    filter_cosmetics: "آرایشی و جواهرات",
    filter_modeling: "مدلینگ ادیتوریال",
    filter_sport: "خودرو و سرعت",
    filter_portrait: "پرتره و هنر والا",
    view_exhibition: "مشاهده نمایشگاه",

    // Collective Section
    collective_tag: "استادان و طراحان بصری",
    collective_title: "گروه هنری فتروث",
    collective_lead: "مجموعه‌ای یکپارچه از مدیران خلاقیت، مهندسان ارشد نورپردازی و متخصصان ریتاچ تبلیغاتی برای خلق آثار بصری ماندگار در سطح جهانی.",
    collective_founder_badge: "بنیان‌گذار و مدیر خلاقیت",
    collective_specialist_badge: "متخصص نورپردازی و ریتاچ تبلیغاتی",
    view_dossier: "مشاهده رزومه و آثار هنرمند",
    born_lbl: "زادگاه و تاریخ",
    education_lbl: "تحصیلات",
    expertise_lbl: "تخصص‌های کلیدی",
    clients_lbl: "همکاری‌های شاخص",
    exhibitions_lbl: "نمایشگاه‌های برگزیده",
    ...
    // About & Philosophy Section
    about_tag: "بیانیه و اصالت بصری",
    about_title: "هندسه سکوت",
    about_lead: "فتروث به عنوان یک خانه هنری تراز اول عمل می‌کند: ۶۰٪ پروژه‌های تجاری لوکس، ۲۵٪ نمایشگاه‌های موزه‌ای و هنر والا، و ۱۵٪ آموزش پیشرفته بین‌المللی.",
    ...
    read_essay: "مطالعه جستار",

    // Inquiry & Contact
    contact_tag: "درخواست همکاری خصوصی",
    contact_title: "آغاز همکاری",
    contact_lead: "برای سفارش کمپین‌های تجاری، خرید نسخه‌های چاپ اصیل گالری، پروژه‌های نمایشگاهی یا پذیرش در مسترشیپ خصوصی آکادمی.",
    rep_title: "نمایندگی‌های بین‌المللی",
    form_name_lbl: "نام و نام خانوادگی / نام سازمان *",
    form_email_lbl: "نشانی ایمیل *",
    form_purpose_lbl: "موضوع و نوع پروژه *",
    form_budget_lbl: "برآورد تقریبی بودجه / مقیاس پروژه",
    form_msg_lbl: "خلاصه بریف و جزئیات چشم‌انداز شما *",
    form_submit_btn: "ارسال درخواست خصوصی",
    purp_comm: "کمپین تجاری و صنعتی",
    purp_edit: "عکاسی ادیتوریال و مد",
    purp_acad: "پذیرش در آکادمی فتروث",
    purp_print: "خرید نسخه چاپی موزه‌ای",

    // Footer
    footer_desc: "استودیوی بین‌المللی عکاسی، هنرهای تجسمی و مدیریت خلاقیت برندهای فاخر.",
    footer_tagline: "تجاری لوکس • ادیتوریال • سینمایی"
  }
};
